...
public:                                                                                \
    static bool const __x_pack_value = true;                                           \
    template <class __X_PACK_DOC, class __X_PACK_ME>                                   \
    void __x_pack_decode(__X_PACK_DOC &__x_pack_obj, __X_PACK_ME &__x_pack_self,       \
                         const xpack::Extend *__x_pack_extp)                           \
    {                                                                                  \
        (void)__x_pack_extp;                                                           \
    }                                                                                  \
    template <class __X_PACK_DOC, class __X_PACK_ME>                                   \
    void __x_pack_encode(__X_PACK_DOC &__x_pack_obj, const __X_PACK_ME &__x_pack_self, \
                         const xpack::Extend *__x_pack_extp) const                     \
    {                                                                                  \
        (void)__x_pack_extp;                                                           \
    }
